...
const features: Feature[] = [
  ...
  },
  {
    ...
    list: ["No somos un restaurante que lleva sus platos a domicilio", "Tenemos flota de repartidores propia", "Atención telefónica personal para resolución de incidencias con tu pedido"],
  },
];
