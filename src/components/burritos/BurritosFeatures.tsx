import { Flame, Wheat, Drumstick, SprayCan, Icon, type LucideProps } from "lucide-react";
...
const features: Feature[] = [
  ...
  {
    icon: Wheat,
    title: "Compatible con tus objetivos deportivos",
  ...
  },
  {
    ...
    list: ["Burger", "California", "Carnitas", "San Francisco", "Trufado"],
  },
  {
    icon: SprayCan,
    title: "Nativos en comida para llevar",
    list: ["Estamos especializados en Take away y Delivery desde 1986", "Tenemos flota de repartidores propia", "Atención telefónica personal para resolución de incidencias"],
  },
];

const BurritosFeatures = () => {
  return (
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-14 space-y-5 max-w-3xl mx-auto">
          ...
          <h2 className="font-display text-4xl md:text-5xl lg:text-6xl font-medium text-foreground leading-[1.1] text-balance">
            Burritos mejicanos proteicos a domicilio en Valencia
          </h2>
...
export default BurritosFeatures;
